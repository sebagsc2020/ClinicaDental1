...
window.renderVerCierreView = function(cierreId, numeroCierre) {
  ...
  el.innerHTML = `
    <div class="page-header">
      ...
      <button class="btn btn-secondary" onclick="exportarPdfCierre('${cierreId}', ${numeroCierre || '?'})">
...
// ============================================================
// NOTA: Las funciones showToast, $, db, renderPresupuestos deben estar definidas globalmente
// ============================================================
